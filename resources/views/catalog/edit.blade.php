		...
		<div class="card">
			...
			<div class="card-body" style="padding:30px">
				<form method="POST">
					...
					<!-- Esto podemos lograrlo mediante la función {{ method_field('PUT') }} -->
...
<script type="text/javascript" src="{{ url('/assets/autosize.min.js') }}"></script>
<script type="text/javascript">
	autosize(document.querySelectorAll('textarea')); //Cambiar tamaño del textarea automaticamente
</script>
